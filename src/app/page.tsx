      ...
      <AppShell title="Dashboard">
        <div className="flex-1 space-y-4 p-4 sm:p-8 pt-6">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <ProgressCard title="Gamble-Free Streak" value="128" unit="days" description="You're doing great!" />
            <ProgressCard title="Money Saved" value="$640" unit="saved" description="from not gambling" />
